...
Establece el límite de la información. En una gestión de crisis, el silencio no es una opción pero la transparencia total tampoco. Debes identificar qué datos son confidenciales y tener preparada una respuesta educada pero firme para cerrar esa puerta. Si no decides dónde termina tu respuesta, el entrevistador encontrará el punto donde tu comodidad se convierte en exposición.
